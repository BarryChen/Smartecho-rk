...
import com.rockchip.echo.smartecho.nlu.iflytek.TextUnderstand;
import com.rockchip.echo.smartecho.stt.JsonParser;
...
//	 听写对象
	...
	RecognizerListener mIatListener = new RecognizerListener() {
		...
		public void onResult(RecognizerResult result, boolean isLast) {
			LogUtil.d("====== mIatListener onProcess");
			printResult(result);
...
//			mRecorder.stopRecording();
	...
	private TextUnderstanderListener mTextUnderstanderListener = new TextUnderstanderListener() {
		...
		public void onResult(final UnderstanderResult result) {
			LogUtil.d("========= TextUnderstanderListener - onProcess =========");
			if (null != result) {
				// 显示
...
//					mResultEdit.setText(showtext);
					...
					TextUnderstand textUnderstand = new TextUnderstand(UnderstandText);
					String ttsText = textUnderstand.getTtsText();
